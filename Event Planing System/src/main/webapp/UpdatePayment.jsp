<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@page import="java.sql.Connection" %>
        <%@page import="java.sql.DriverManager" %>
          ...
          <form action=" UpdatePaymentServelet" method="post">
                                            <div class="col-50">
                                                <h3>Payment</h3>
                                                ...
                                                <input type="hidden" id="cardname" name="id"
                                                    placeholder="Cardholder's Name" value="<%= rs.getString(1) %>">
                                                <label for="cardname">Name on Card</label>
                                                <input type="text" id="cardname" name="cardname"
                                                    placeholder="Cardholder's Name" value="<%= rs.getString(2) %>">
                                                <label for="cardnumber">Credit card number</label>
                                                <input type="text" id="cardnumber" name="cardnumber"
                                                    placeholder="1111-2222-3333-4444" value="<%= rs.getString(3) %>">
                                                ...
                                                <div class="row">
                                                    <div class="col-50">
                                                        ...
                                                        <input type="text" id="expyear" name="expyear"
                                                            placeholder="2023" value="<%= rs.getString(5) %>">
                                                    </div>
                                                    <div class="col-50">
                        ...
                        <section>
                            <div class="icon">
                                ...
                                <div class="icon" align="center">
                                    ...
                                    <p>Rubik Event (SE_OOP_2023_S2_MLB_WD_G335_Online Event Planning System) 2023 - All
                                        Rights
                                        Reserved</p>
                                </div>
                            </div>
